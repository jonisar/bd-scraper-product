          ...
          <details className="hidden-cost-details">
            ...
            <div className="hidden-cost-body">
              ...
              <ul className="hidden-cost-list">
                <li><span className="hidden-cost-item">Compute / runtime units</span><span className="hidden-cost-note">commonly billed per scraper runtime hour or CU</span><span className="hidden-cost-included">✓ Included</span></li>
