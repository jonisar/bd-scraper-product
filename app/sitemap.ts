...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    "/products/web-scraper/ecommerce",
    "/products/web-scraper/social-media",
    "/products/web-scraper/b2b",
    "/products/web-scraper/jobs",
    "/products/web-scraper/real-estate",
    "/products/web-scraper/travel",
    "/products/web-scraper/search",
    "/products/web-scraper/finance",
    "/products/web-scraper/news-media",
