...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    "/products/web-scraper/scraper-lib/categories/social-media",
    "/products/web-scraper/scraper-lib/categories/ecommerce",
    "/products/web-scraper/scraper-lib/categories/b2b",
    "/products/web-scraper/scraper-lib/categories/jobs",
    "/products/web-scraper/scraper-lib/categories/real-estate",
