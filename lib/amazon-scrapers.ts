...
export const AMAZON_SITE = {
  ...
  description:
    "Scrape Amazon and collect data such as ASIN, seller name, merchant ID, title, URL, image URL, category tree, brand, product overview, description, sizes, colors, styles, availability, arrival time, initial price, final price, models, images, features, ratings, and reviews.",
  scraperCount: 14,
} as const;
...
export const AMAZON_SCRAPERS: AmazonScraper[] = [
  {
    ...
    fieldsPreview: "Title, Seller name, Brand, Description, Initial price, Currency, Availability, Reviews count, and more.",
    views: "34.7K+",
    downloads: "5.7K+",
  ...
  },
  {
    ...
    fieldsPreview: "URL, Product name, Product rating, Rating, Author name, ASIN, Review title, Review text, and more.",
    views: "7.3K+",
    downloads: "858+",
    href: `${BD}/reviews`,
  },
  {
    ...
    fieldsPreview: "Seller id, URL, Seller name, Description, Stars, Feedbacks, Return policy, and more.",
    views: "2.5K+",
    downloads: "368+",
    href: `${BD}/seller`,
  },
  ...
  },
  {
    ...
    fieldsPreview: "Asin, URL, Name, Sponsored, Initial price, Final price, Currency, Sold, and more.",
    views: "1.6K+",
    downloads: "178+",
    href: BD,
  },
