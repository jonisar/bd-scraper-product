...
type AgentSetupCtaProps = {
  ...
  variant?: "scraper" | "hub";
  /** Compact sizing for sticky demo headers */
  size?: "md" | "sm";
  prompt?: string;
};
  ...
  return (
    ...
    >
      {copied ? (
        ...
        <>
          Try in your agent
          <svg viewBox="0 0 16 16" className={sm ? "h-3 w-3" : "h-3.5 w-3.5"} fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
