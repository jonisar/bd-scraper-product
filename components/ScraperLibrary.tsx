  ...
  return (
    <div className="lib">
          ...
          {filtered.length > 0 ? (
            ...
            <div className="lib-empty">
              ...
              <p className="lib-empty-sub">
                ...
                <a href="https://brightdata.com/cp/scrapers/automation/chat" className="lib-empty-link">
      ...
      <div className="lib-cta">
        <p>
          Showing {catalog.length} of <strong>1,238+ production-ready scrapers</strong> in the full library.
        </p>
        <a
          href="https://brightdata.com/cp/scrapers/browse?category=all"
  ...
  return (
    <div className="fc">
      ...
      <div className="fc-foot">
        ...
        <span className="fc-badge">✓ GDPR</span>
        <span className="fc-badge">✓ CCPA</span>
        <a
