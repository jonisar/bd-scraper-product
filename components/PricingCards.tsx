  ...
  return [
    {
      ...
      price: "5K",
      unit: `${unit}/mo`,
      features: ["No credit card required", `All ${unit === "page loads" ? "AI generation" : "scrapers"} included`, "Full API access", "Expert support"],
      cta: "Start free",
      href: SIGNUP,
    },
    {
      ...
      price: "$1.00–1.50",
      unit: `/1K ${unit}`,
      features: ["Pay only for success", "Retries and slow pages: on us, not you", "Unlimited concurrency", "Set monthly spend limits"],
      cta: "Start free",
      href: SIGNUP,
      featured: true,
    },
